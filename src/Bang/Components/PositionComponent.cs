...
public readonly struct PositionComponent : IParentRelativeComponent, IEquatable<PositionComponent>
{
    ...
    public PositionComponent WithLocal(Vector2 localPosition) => WithLocal(localPosition.X, localPosition.Y);
    ...
    {
        Vector2 parentGlobalPosition = ((PositionComponent)parentComponent).GetGlobal();
    ...
    public override bool Equals(object? obj) => obj is PositionComponent c && Equals(c);
}